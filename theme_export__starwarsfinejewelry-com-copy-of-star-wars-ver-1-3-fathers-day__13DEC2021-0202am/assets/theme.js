...
$(document).ready(function() {
      ...
      if(bannerSlider.length) {
        bannerSlider.slick({
          ...
          customPaging: function(slider, i) { 
            return '<button>' + $(slider.$slides[i]).find(".sw__banner-slide").attr('title') + '</button>';
          },
          arrows: false,
          fade: true,
          slidesToShow: 1,
          slidesToScroll: 1,
          asNavFor: '.mm_banner-dots',
          responsive: [
            {
              breakpoint: 800,
              settings: {
  ...
  var isFatherDayPage = window.location.href;

  if(isFatherDayPage.indexOf('fathers-day-2021')>-1){
	homePage.initCollectionSlider();
  }
...
// Register form validation
  ...
  $('#CustomerRegisterForm form').on('submit', function(e) {
