...
$(document).ready(function() {
  ...
  if(currentPageUrl.indexOf('kyber-radiance-pendant')>-1){
...
//     if(validation == true) {
    ...
    console.log(firstName.val(),firstNameString.indexOf('Mr '));
      if(firstNameString.indexOf('Mr ')<0 && firstNameString.indexOf('Ms ')<0){
