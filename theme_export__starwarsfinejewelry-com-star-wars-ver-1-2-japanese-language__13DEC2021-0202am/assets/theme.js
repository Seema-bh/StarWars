...
$(document).ready(function() {
  ...
  var kyberCrystalRadiance = {
    scrollVideo: function() {
      ...
      const currentFrame = index => (`https://cdn.shopify.com/s/files/1/0420/2371/4967/files/WhatsApp_Video_2021-05-04_at_17.46.54_${index.toString().padStart(3, '0')}.jpg`)
      ...
      const updateImage = index => {
        ...
        window.addEventListener('scroll', () => {  
                                ...
                                const frameIndex = Math.min(frameCount - 1,Math.ceil(scrollFraction * frameCount));
      							const NewFrameIndex = frameIndex*5;
		console.log(frameIndex,NewFrameIndex);
        requestAnimationFrame(() => updateImage(frameIndex + 5))
      });
