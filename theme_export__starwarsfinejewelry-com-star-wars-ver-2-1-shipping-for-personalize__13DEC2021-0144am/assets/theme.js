...
//         .addClass(this.classes.cartPopupWrapperHidden);
    ...
    _liveRegionText: function(variant) {
      ...
      if (variant.compare_at_price > variant.price) {
        ...
        $('.product-single__meta .price-item--discount').html('('+discountOff+'% OFF)');
      }
      ...
      function(section) {
        ...
        if (recommendationsMarkup.trim() !== '') {
          ...
          $('.sw__also-bought').slick({
            arrows: true,
            prevArrow:'<div class="slick-prev prev-btn"><svg class="slider_prevbtn" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 36 42"><defs><style>.slider_prevbtn .a{fill:#242424;}.slider_prevbtn .b{fill:none;stroke:#fff;stroke-width:2px;}</style></defs><g transform="translate(-145 -2163)"><path class="a" d="M31.5,0,42,18,31.5,36h-21L0,18,10.5,0Z" transform="translate(145 2205) rotate(-90)"/><path class="b" d="M-6298.257,2306.837l-5.642,5.029,5.642,4.823" transform="translate(6464.104 -127.53)"/></g></svg></div>',
            nextArrow:'<div class="slick-next next-btn"><svg class="slider_nextbtn" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 36 42"><defs><style>.slider_nextbtn .a{fill:#242424;}.slider_nextbtn .b{fill:none;stroke:#fff;stroke-width:2px;}</style></defs><path class="a" d="M31.5,0,42,18,31.5,36h-21L0,18,10.5,0Z" transform="translate(36) rotate(90)"/><path class="b" d="M-6303.9,2306.837l5.642,5.029-5.642,4.823" transform="translate(6319.052 -2290.53)"/></svg></div>',
            infinite: false,
            autoplay: false,
            speed: 300,
            slidesToShow: 3,
...
$(document).ready(function() {
  ...
  $(".buy-now-button .btn").on("click",function(e){
    ...
    var isPersonalizeProduct = $('.name_engraving').length;
    var formData;
    //clear.js, //add.js
    if(isPersonalizeProduct){
      var font = $('.font_btn input:checked').val();
      var Engraved = $('#embros_txt').val();
      var formData = {
        'items': [
          {
            'id': variantId,
    ...
    if(currentPageUrl.indexOf('/ja/')>-1){
      $.ajax({
        ...
        async: false,
        beforeSend: function() {
          $(".before-touch").css('display','none');
          $(".after-touch").css("display",'block');
        },
        success: function(data){ 
  ...
  // Get the video
  var video = document.getElementById("homepage-video_personalize");
  ...
  var videoHeader = document.getElementById("homepage-mob-video_personalize");
  ...
  if($(window).width()<767){
    var textSlider = $('.heading-wrapper');
  ...
  var homePage = {
    ...
    initCustomSlider: function() {
      var CustomSlider = $('.custom-content-wrapper .custom-content');
...
// Register form validation
  ...
  // Homepage & checkout loader spinner js start
    $(document).on('click','.cart__submit-controls .cart__submit', function(){
      $(this).children('.before_click').addClass('hide');
      $(this).children('[data-loader]').removeClass('hide');
    });
    $(document).on('click','.product-card [data-add-to-cart]', function(){
      console.log('HP btn');
      $(this).children('.before-touch').addClass('hide');
      $(this).children('.after-touch').removeClass('hide');
    });
  // Homepage & checkout loader spinner js end

  // Last minute deal banner js start
  window.setInterval(function() {
    $(".banner_text .animation_txt").each(function() {
